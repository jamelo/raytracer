...
TEST(ShapeTest, Plane)
{
    ...
    ASSERT_NEAR(p.calculateRayIntersection(r1), 1.0, 1e-10);
    ASSERT_NEAR(p.calculateRayIntersection(r2), 1.0, 1e-10);
    ASSERT_NEAR(p.calculateRayIntersection(r3), sqrt(2), 1e-10);
}
